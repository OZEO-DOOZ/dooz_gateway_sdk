...
_$SetScenarioResponse _$_$SetScenarioResponseFromJson(
    Map<String, dynamic> json) {
...
Map<String, dynamic> _$_$SetScenarioResponseToJson(
...
Map<String, dynamic> _$_$SetEpochResponseToJson(_$SetEpochResponse instance) =>
    <String, dynamic>{
      'node': instance.node,
      'io': instance.io,
